...
import org.com1027.formative.ab00631.Employee;
...
public class EmployeeTest {
  ...
  public void testDisplayRecord() {
    ...
    assertEquals("James, Sid (1234): Director at £100000.0 (£29822.0 tax) and is eligible for bonus.", employee.toString());
  }
  ...
  public void testDisplayRecordNoBonus() {
    ...
    assertEquals("Bloggs, Joe (5678): Sales Person at £30000.0 (£4112.0 tax) and is not eligible for bonus.", employee.toString());
  }
}
